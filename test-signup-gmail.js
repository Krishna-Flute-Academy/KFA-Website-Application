...
async function runTest() {
    const email = 'teacher.test.' + Math.random().toString(36).substring(7) + '@gmail.com';
    const password = 'Password123!';
    const name = 'Test Teacher';

    console.log(`Step 1: Signing up a new teacher with Gmail: ${email}...`);
    ...
    const { data: studentData, error: studentError } = await authenticatedClient
        ...
        .insert([{
            name: 'Test Student',
            email: 'student.test.' + Math.random().toString(36).substring(7) + '@gmail.com',
            phone: '1234567890',
            role: 'student',
            status: 'active',
