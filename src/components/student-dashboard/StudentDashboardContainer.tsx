                        ...
                        <div className="flex items-center gap-4 text-[#5C5852]">
                            <div className="relative flex" ref={notifDropdownRef}>
                                ...
                                {showNotificationsDropdown && (
                                    <div className="absolute right-0 md:right-0 mt-8 w-[calc(100vw-2rem)] max-w-sm sm:w-80 bg-[#FAF6F0] rounded-xl border border-[#E6E1DA] shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
