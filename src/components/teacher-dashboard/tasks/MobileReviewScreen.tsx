        ...
        <div className="fixed inset-0 z-[80] bg-white dark:bg-slate-950 flex flex-col font-sans overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-5">
                ...
                {submission.status === 'reviewed' && (
                    <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 p-3 rounded-2xl flex items-start gap-2.5">
                        ...
                        <div className="text-xs space-y-0.5">
                            ...
                            <p className="text-blue-700 dark:text-blue-300 leading-relaxed text-[11px]">
                                Changes were previously requested. If the student fixed file permissions or updated the link, review it below and click <strong>Approve Task</strong>.
                            </p>
                        </div>
                    </div>
                )}
